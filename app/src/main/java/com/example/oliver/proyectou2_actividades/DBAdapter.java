...
public class DBAdapter {
    ...
    public static final String DATABASE_CREATE =
            "create table contacts (_id integer primary key autoincrement, "
                    + "name text not null, email text not null, phone text not null, career text not null);";
    ...
    public long insertContact(String name, String email, String phone, String career) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_NAME, name);
        initialValues.put(KEY_EMAIL, email);
        initialValues.put(KEY_PHONE, phone);
        initialValues.put(KEY_CAREER, career);
    ...
    public Cursor getAllContacts() {
        return db.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_NAME,
                KEY_EMAIL, KEY_PHONE, KEY_CAREER}, null, null, null, null, null,null);
    }
